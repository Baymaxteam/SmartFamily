...
angular
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
        ...
        .state('dashboard.scheduleLiving', {
                templateUrl: 'views/room-schedule/scheduleLiving.html',
                url: '/scheduleLiving'
            })
            .state('dashboard.scheduleBedMain', {
                templateUrl: 'views/room-schedule/scheduleBedMain.html',
                url: '/scheduleBedMain'
            })
            .state('dashboard.scheduleBedGuest', {
                templateUrl: 'views/room-schedule/scheduleBedGuest.html',
                url: '/scheduleBedGuest'
            })
            .state('dashboard.scheduleBath', {
                templateUrl: 'views/room-schedule/scheduleBath.html',
                url: '/scheduleBath'
            })
            .state('dashboard.scheduleAdd', {
                templateUrl: 'views/room-schedule/scheduleAdd.html',
                url: '/scheduleAdd'
            })
